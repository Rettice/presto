...
{
    /**
     * Default schema name to use in the connector.
     */
    ...
    /**
     * Directory that contains the JSON description files for Elasticsearch Index.
     */
     ...
     * Scroll timeout.
     */
    private Duration scrollTime = new Duration(60, SECONDS);

    /**
     * Max number of hits a single ElasticSearch request can fetch.
     */
     ...
     */
    private Duration requestTimeout = new Duration(5, SECONDS);
    ...
    @Config("elasticsearch.scroll-time")
